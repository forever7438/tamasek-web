 ...
 */
;(function () {
    var VERSION = '2.2.3 Black Sun PLC',
        ...
        defaults = {
            classes: '',
            inline: false,
            language: 'en', // BLACKSUN: Changed default language from "ru" to "en"
            startDate: new Date(),
            firstDay: '',
            weekends: [6, 0],
            dateFormat: '',
            ...
            showEvent: 'focus',
            autoClose: true, // BLACKSUN: changed from "false" to "true"
    ...
    datepicker.prototype = {
        ...
        _bindEvents : function () {
            ...
            /* BLACKSUN: on iPad remove the popup on touch */
            $('body').on('touchstart', function (event) {
                if ($(event.target).hasClass('datepicker--cell-day')) {
        ...
        _defineLocale: function (lang) {
            /* BLACKSUN: Changed default language from "ru" to "en" */
    ...
    datepicker.getParsedDate = function (date) {
        return {
            ...
            month: date.getMonth(),
            week: date.getWeek(), // BLACKSUN: added "week" property
    ...
    (function () {
        ...
        datepicker.Body.prototype = {
            ...
            _getYearsHtml: function (date) {
                ...
                for (i = firstYear; i <= decade[1] + 1; i += 1) {
    ...
    (function () {
        ...
        datepicker.Timepicker.prototype = {
            ...
            _onMouseOutRange: function (e) {
                var name = $(e.target).attr("name");
                if (this.d.inFocus) {
                    return; // Prevent removing focus when mouse out of range slider
                }
