        ...
        AmCharts["export"] = function(t, r) {
            var s, d = {
                ...
                libs: {
                    ...
                    autoLoad: !0,
                    reload: !1,
                    resources: ["fabric.js/fabric.min.js", "FileSaver.js/FileSaver.min.js","jszip/jszip.min.js", {
                    ...
                    loadTimeout: 1e4,
                    unsupportedIE9libs: ["pdfmake.min.js", "jszip.min.js"]
                },
                config: {},
                setup: {
                    chart: t,
                    ...
                    function f(w, N) {
                        ...
                        for (S = 0; S < w.length; S++) {
                            ...
                            if (M.format = (M.format + "").toUpperCase(), F.addEventListener("mouseleave", function() {
                                ...
                                }, M) : !M.label && (M.label = M.label ? M.label : d.i18l("menu.label." + P)), -1 != ["CSV", "JSON"].indexOf(M.format) && -1 != ["map", "gauge"].indexOf(d.setup.chart.type)) continue;
